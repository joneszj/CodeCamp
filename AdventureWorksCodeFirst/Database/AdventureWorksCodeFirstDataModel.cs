namespace AdventureWorksCodeFirst.Database
{
    using System;
    ...
    public partial class AdventureWorksCodeFirstDataModel : DbContext
    {
        public AdventureWorksCodeFirstDataModel()
            : base("name=AdventureWorksCodeFirstDataModel")
        {
        }
